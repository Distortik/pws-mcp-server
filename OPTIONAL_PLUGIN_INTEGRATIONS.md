...
The installed TEST providers passed their joint core gate against a copied validation save and its active player promotion. Both matched the same save/promotion context, repeated unchanged reads were stable, and no private fields crossed either boundary. Cross-save and provider-absence checks remain release gates.
